...
public class FindIdPwdController {
    ...
    @ResponseBody
    public ResponseEntity<String> findIdVerify(@RequestBody @Validated(ValidationGroups.EmailCheckGroup.class) StaffDto staffDto, BindingResult bindingResult, HttpServletRequest request) {
    ...
    public ResponseEntity<Map<String, String>> verificationCodeToFindId(@RequestBody Map<String, String> requestBody, HttpServletRequest request) {
        ...
        try {
            if (inputMailKey.equals(savedMailKey)) {
                ...
                String id = staffService.findIdByEmail(email);
    ...
    @ResponseBody
    public ResponseEntity<String> findPwdVerify(@RequestBody @Validated({ValidationGroups.EmailCheckGroup.class, ValidationGroups.IdCheckGroup.class}) StaffDto staffDto, BindingResult bindingResult, HttpServletRequest request) {
    ...
    public String modifyPwd2(@Validated(ValidationGroups.LoginCheckGroup.class) StaffDto staffDto, BindingResult bindingResult, Model model, HttpServletRequest request, RedirectAttributes ra) {
        String errorMsg = "";
        if (bindingResult.hasErrors()) {
